...
#include "..\..\common\include\asm_i386.h"
#include "..\..\common\include\quakeasm.h"
#include "..\include\asm_draw.h"
#include "..\..\common\include\d_ifacea.h"
...
LDraw8:
	...
	movb	%dh,%ah
	movb	(%esi),%al
	cmpb	$(TRANSPARENT_COLOR),%al	// Manoel Kasimier - transparent pixels in alias models
	jz		Lp1							// Manoel Kasimier - transparent pixels in alias models
	movw	%bp,(%ecx)
...
LDraw7:
	...
	movb	(%esi),%al
	cmpb	$(TRANSPARENT_COLOR),%al	// Manoel Kasimier - transparent pixels in alias models
	jz		Lp2							// Manoel Kasimier - transparent pixels in alias models
	movw	%bp,2(%ecx)
	movb	0x12345678(%eax),%al
LPatch7:
	movb	%al,1(%edi)
...
LDraw6:
	...
	movb	(%esi),%al
	cmpb	$(TRANSPARENT_COLOR),%al	// Manoel Kasimier - transparent pixels in alias models
	jz		Lp3							// Manoel Kasimier - transparent pixels in alias models
	movw	%bp,4(%ecx)
	movb	0x12345678(%eax),%al
LPatch6:
	movb	%al,2(%edi)
...
LDraw5:
	...
	movb	(%esi),%al
	cmpb	$(TRANSPARENT_COLOR),%al	// Manoel Kasimier - transparent pixels in alias models
	jz		Lp4							// Manoel Kasimier - transparent pixels in alias models
	movw	%bp,6(%ecx)
	movb	0x12345678(%eax),%al
LPatch5:
	movb	%al,3(%edi)
...
LDraw4:
	...
	movb	(%esi),%al
	cmpb	$(TRANSPARENT_COLOR),%al	// Manoel Kasimier - transparent pixels in alias models
	jz		Lp5							// Manoel Kasimier - transparent pixels in alias models
	movw	%bp,8(%ecx)
	movb	0x12345678(%eax),%al
LPatch4:
	movb	%al,4(%edi)
...
LDraw3:
	...
	movb	(%esi),%al
	cmpb	$(TRANSPARENT_COLOR),%al	// Manoel Kasimier - transparent pixels in alias models
	jz		Lp6							// Manoel Kasimier - transparent pixels in alias models
	movw	%bp,10(%ecx)
	movb	0x12345678(%eax),%al
LPatch3:
	movb	%al,5(%edi)
...
LDraw2:
	...
	movb	(%esi),%al
	cmpb	$(TRANSPARENT_COLOR),%al	// Manoel Kasimier - transparent pixels in alias models
	jz		Lp7							// Manoel Kasimier - transparent pixels in alias models
	movw	%bp,12(%ecx)
	movb	0x12345678(%eax),%al
LPatch2:
	movb	%al,6(%edi)
...
LDraw1:
	...
	movb	(%esi),%al
	cmpb	$(TRANSPARENT_COLOR),%al	// Manoel Kasimier - transparent pixels in alias models
	jz		Lp8							// Manoel Kasimier - transparent pixels in alias models
	movw	%bp,14(%ecx)
	movb	0x12345678(%eax),%al
LPatch1:
	movb	%al,7(%edi)
...
LExactlyOneLong:
	...
	movb	(%ebx),%al
	cmpb	$(TRANSPARENT_COLOR),%al	// Manoel Kasimier - transparent pixels in alias models
	jz		LNextSpanESISet				// Manoel Kasimier - transparent pixels in alias models
	movw	%bp,(%ecx)
	movb	0x12345678(%eax),%al
LPatch9:
	movb	%al,(%edi)
