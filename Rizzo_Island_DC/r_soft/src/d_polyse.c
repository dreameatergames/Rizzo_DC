...
//#if	!id386 // Manoel Kasimier - transparencies - removed
...
#if	!id386 // Manoel Kasimier - transparencies
...
#endif	// !id386 // Manoel Kasimier - transparencies
...
//#endif	// !id386 // Manoel Kasimier - transparencies - removed
...
#if	0//id386 // Manoel Kasimier - transparencies - edited
...
void D_PolysetDrawSpans8_Shadow (spanpackage_t *pspanpackage) // Manoel Kasimier - EF_SHADOW - edited
{
	...
	int		dist;
	byte	*shadowmap;
	shadowmap = vid.colormap + ((32 + (int)(31.0*currententity->alpha) ) * 256);
	// Manoel Kasimier - end
...
#if	id386
	if (!use_c_renderer) // Manoel Kasimier - transparencies
	{
	d_sfrac = (plefttop[2] & 0xFFFF) << 16;
	d_tfrac = (plefttop[3] & 0xFFFF) << 16;
	}
	else // Manoel Kasimier - transparencies
#endif
	{
...
// count field
	...
	else if (currententity->alpha == 1.0f) // Manoel Kasimier - transparencies
